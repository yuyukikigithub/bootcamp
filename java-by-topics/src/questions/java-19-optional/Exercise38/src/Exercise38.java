...
public class Exercise38 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("op is Present: " + op.orElseThrow(()-> new Exception("it's throwing my Custom Expection"))); // revise it

        // new IllegalArgumentException("it's throwing my Custom Expection")
    }
}
